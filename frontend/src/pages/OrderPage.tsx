...
export const OrderPage = () => {
  ...
  useEffect(() => {
    if (!category || !['alphonso', 'jaggery', 'oil'].includes(category)) {
  ...
  const handleCategorySwitch = (
    newCategory: 'alphonso' | 'jaggery' | 'oil'
  ) => {
        ...
        <section className="order-page-header">
          <div className="container">
            <div className="order-page-title-section">
              <h1 className="order-page-title">{currentCategoryInfo.title}</h1>
